...
export const printBackendWebserverCode = PromptTemplate.fromTemplate(
    `FUNCTION: printBackendWebserverCode
...
export const printImprovedWebServerCode = PromptTemplate.fromTemplate(
    `FUNCTION: printImprovedWebServerCode
    /// INPUT: Takes in a PROJECT_DESCRIPTION and CODE_TEMPLATE for a website backend build
...
export const printFixedCode = PromptTemplate.fromTemplate(
    `FUNCTION: printFixedCode
...
export const printRestAPIEndpoints = PromptTemplate.fromTemplate(
    `FUNCTION: printRestAPIEndpoints
